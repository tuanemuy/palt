    ...
    >
      <Container position="relative" my="m.50">
        <article className={article}>
          <h1>個人情報保護方針</h1>
          <p>
            スタジオ・スイロ（以下、「当社」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）における、ユーザーの個人情報の取扱いについて、以下のとおり個人情報保護方針（以下、「本ポリシー」といいます。）を定めます。
          </p>
          ...
          <p>
            ...
            <br />
            Webサイト：
            <NextLink href="https://suiro.ink" target="_blank">
              https://www.suiro.ink
            </NextLink>
            <br />
            Email：contact@suiro.ink
          </p>
        </article>
      </Container>
    </Frame>
