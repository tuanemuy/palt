...
pyftsubset "../../assets/fonts/TazuganeGothicStdN-Regular.otf" --text-file="./chars.txt" --layout-features='*' --flavor=woff --output-file="../../public/fonts/TazuganeGothicStdN-Regular.woff"
pyftsubset "../../assets/fonts/TazuganeGothicStdN-Regular.otf" --text-file="./chars.txt" --layout-features='*' --flavor=woff2 --output-file="../../public/fonts/TazuganeGothicStdN-Regular.woff2"
